...
cmd({
  ...
  try {
    ...
    // Check update status
    let updateMessage = `✅ Your Minix-MD bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your Minix-MD bot is outdated!
...
Use *.update* to update.`;
    ...
    const statusMessage = ` *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* \n\n` +
      ...
      ` *Changelog:*\n${latestChangelog}\n\n` +
      ` *GitHub Repo:* ${githubRepo}\n *Owner:* [Marlon](https://github.com/Montanatech1)\n\n${updateMessage}\n\n *Hey! Don't forget to fork & star the repo!*`;
